...
// By: devicon-plain
// See: https://v0.app/icon/devicon-plain/typescript
// Example: <IconDeviconPlainTypescript width="24px" height="24px" style={{color: "#000000"}} />

export const IconDeviconPlainTypescript = ({
  height = "1em",
  fill = "currentColor",
  focusable = "false",
  ...props
